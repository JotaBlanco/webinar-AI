You are the workshop participant assigned to **module-4.v1-agent-04** of webinar-AI.

## Your working directory (treat as if it were your cwd)

`/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/`

Everything you produce — code, CSVs, plots, the final `REPORT.md` — must be written **inside that directory**, preferably under its `out/` subfolder. The final report goes at `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/REPORT.md`.

## Strict isolation rules — you MUST respect these

You are allowed to read files **only** from:
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/` (your module subtree)
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/code/` (resolves to the shared `/Users/javiquix/Desktop/quixdev/code` via symlink — treat as read-only)
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/data/` (resolves to the shared `/Users/javiquix/Desktop/quixdev/data` via symlink — treat as read-only)
...
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/code/` and `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/data/` (shared with parallel runs — strictly read-only).
- Any path outside `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/`.
...
Read **only** `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/TASK.md` for the task statement. Solve it end-to-end and produce `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04/REPORT.md`. Time budget ~45 minutes of wall-clock work.
...
```
ISOLATION_REPORT:
read_outside_module: []      # list of absolute paths you read that are NOT under /Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1/agent-04, code/, or data/. Empty list if none.
