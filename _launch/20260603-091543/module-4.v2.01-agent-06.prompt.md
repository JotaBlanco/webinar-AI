You are the workshop participant assigned to **module-4.v2.01-agent-06** of webinar-AI.

## Your working directory (treat as if it were your cwd)

`/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/`

Everything you produce — code, CSVs, plots, the final `REPORT.md` — must be written **inside that directory**, preferably under its `out/` subfolder. The final report goes at `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/REPORT.md`.

## Strict isolation rules — you MUST respect these

You are allowed to read files **only** from:
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/` (your module subtree)
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/code/` (resolves to the shared `/Users/javiquix/Desktop/quixdev/code` via symlink — treat as read-only)
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/data/` (resolves to the shared `/Users/javiquix/Desktop/quixdev/data` via symlink — treat as read-only)
...
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2.v2`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2.v3`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-3`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-3.v2`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-3.v3`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v1`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/_grade`
- `/Users/javiquix/Desktop/quixdev/F1`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-01`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-02`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-03`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-04`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-05`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-07`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-08`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-09`
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-10`

You are **forbidden** from writing to:
- `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/code/` and `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/data/` (shared with parallel runs — strictly read-only).
- Any path outside `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/`.
...
- **AGENTS.md guidance (m4 closed-loop framing: inner-loop recipe, RPI phase separation, parallel rung subagents)**
- **skills/ toolkit inherited from m3.v3 (score-model + cv.py, fit-model, compare-models, inspect-residuals, visualise-segment, make-train-dev-split, load-segments, assess-candidate-model, pre-flight-final-model)**
- **skills/ m4 additions (iterate [one-shot tree-search step], critique-residuals [typed-grounded router], visualise-tree, residual-structure, route-bias)**
- **references/ domain knowledge (anti-patterns, approach-menu, two-kpi-tradeoff, exploration-discipline, dynamics-formulations, ceiling-moves, closing-the-loop, m4-cohort-findings)**
- **EXPERIMENTS.md append-only log template**
- **MODELS.md registry with parent: field**
- **TREE.json machine-readable tree (managed by skills/iterate)**
- **_shared/ math helpers (traj_metrics, rung1_starter linear-dynamic scaffold with RK4)**
- **rpi/ three-phase Research-Plan-Implement driver with hard-locked artifacts**
- **launch-rungs/ parallel divergent rung subagent manifest + launch script**
...
Read **only** `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/TASK.md` for the task statement. Solve it end-to-end and produce `/Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06/REPORT.md`. Time budget ~45 minutes of wall-clock work.
...
```
ISOLATION_REPORT:
read_outside_module: []      # list of absolute paths you read that are NOT under /Users/javiquix/Desktop/quixdev/webinar-AI/module-4.v2.01/agent-06, code/, or data/. Empty list if none.
