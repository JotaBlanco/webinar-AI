...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-E/module-4/agent-04`
...
5. **Write strict JSON to `/Users/javiquix/Desktop/quixdev/webinar-AI/raw-model/idea-01/_grade/20260527-164838/canonical/angleE-m4-agent-04.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for angleE-m4-agent-04: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-E/module-4/agent-04/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-E/module-4/agent-04/data/` (these are symlinks to shared, read-only resources).
