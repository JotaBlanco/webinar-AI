...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-D/module-4/agent-01`
...
5. **Write strict JSON to `/Users/javiquix/Desktop/quixdev/webinar-AI/raw-model/idea-01/_grade/20260527-164838/canonical/angleD-m4-agent-01.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for angleD-m4-agent-01: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-D/module-4/agent-01/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-D/module-4/agent-01/data/` (these are symlinks to shared, read-only resources).
