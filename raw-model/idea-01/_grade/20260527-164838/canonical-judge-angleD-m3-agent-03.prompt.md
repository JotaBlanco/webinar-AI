...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-D/module-3/agent-03`
...
5. **Write strict JSON to `/Users/javiquix/Desktop/quixdev/webinar-AI/raw-model/idea-01/_grade/20260527-164838/canonical/angleD-m3-agent-03.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for angleD-m3-agent-03: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-D/module-3/agent-03/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-D/module-3/agent-03/data/` (these are symlinks to shared, read-only resources).
