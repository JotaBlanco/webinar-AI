...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-A/module-4/agent-05`
...
5. **Write strict JSON to `/Users/javiquix/Desktop/quixdev/webinar-AI/raw-model/idea-01/_grade/20260527-153926/canonical/angleA-m4-agent-05.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for angleA-m4-agent-05: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-A/module-4/agent-05/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-A/module-4/agent-05/data/` (these are symlinks to shared, read-only resources).
