"""Variant D: V1 with K_us2 (nonlinear understeer in |delta|), refit on all data."""
import sys, json
...
PARAMS = json.loads((ROOT / "out" / "fitted_v2.json").read_text())
...
if __name__ == "__main__":
    ...
    print(f"Variant D  yaw={res['yaw_rate_rmse']:.6f}  cte={res['cte_rmse']:.4f}")
