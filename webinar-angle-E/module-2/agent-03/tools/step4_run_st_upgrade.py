...
def main() -> int:
    ...
    P_obj = PARAM_BY_PLATFORM[args.platform]
    # Adapter: tools assumed dict subscript; canonical parameters.py exposes attrs.
    try:
        P = {k: getattr(P_obj, k) for k in ("L", "l_f", "l_r", "m", "C_alpha_f", "C_alpha_r")}
