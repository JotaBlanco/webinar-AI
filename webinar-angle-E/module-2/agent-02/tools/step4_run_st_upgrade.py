...
def main() -> int:
    ...
    # Bridge: parameters module returns frozen dataclasses; tool was written
    # assuming dict-like access. Wrap for compatibility.
    class _Bridge:
        def __init__(self, obj): self._o = obj
        def __getitem__(self, k): return getattr(self._o, k)
    P = _Bridge(_P)
