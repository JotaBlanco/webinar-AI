You are the workshop participant assigned to **module-2-agent-02** of webinar-angle-C.
...
Everything you produce — code, CSVs, plots, the final `REPORT.md` — must be written **inside that directory**, preferably under its `out/` subfolder. The final report goes at `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02/REPORT.md`.

## Strict isolation rules — you MUST respect these

You are allowed to read files **only** from:
- `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02/` (your module subtree)
- `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02/code/` (resolves to the shared `/Users/javiquix/Desktop/quixdev/webinar-AI/code` via symlink — treat as read-only)
- `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02/data/` (resolves to the shared `/Users/javiquix/Desktop/quixdev/webinar-AI/data` via symlink — treat as read-only)
...
- `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02/code/` and `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02/data/` (shared with parallel runs — strictly read-only).
- Any path outside `/Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02/`.
...
```
ISOLATION_REPORT:
read_outside_module: []      # list of absolute paths you read that are NOT under /Users/javiquix/Desktop/quixdev/webinar-AI/webinar-angle-C/module-2/agent-02, code/, or data/. Empty list if none.
