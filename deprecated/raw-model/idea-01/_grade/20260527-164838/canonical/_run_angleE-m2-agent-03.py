#!/usr/bin/env python3
"""Canonical re-eval for angleE-m2-agent-03.
...
OUT_PATH = REPO / "raw-model/idea-01/_grade/20260527-164838/canonical/angleE-m2-agent-03.json"
...
def main() -> int:
    ...
    notes_bits.append(
        "Agent's own (MachE-only, unfiltered) V1 overall RMSE was 0.01469; pooling "
        "across both Ford platforms with v>2 filter is the cross-agent canonical number."
    )
