...
You are working on the lateral-fidelity challenge. The two KPIs to minimise are in your task prompt. You have a starter toolkit of seven skills under `skills/`. They are short on purpose — short enough to read, short enough to change.
