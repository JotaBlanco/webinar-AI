...
- **reconstructed**: 9 ok / 1 failed (wall 3.26s, concurrency 8)
...
|---|---|---|---|---|
| `module-1` | 9/10 | +30.2% ± 3.6% (med +30.6%) | +24.4% ± 4.6% (med +23.3%) | 1 |
...
|---|---|---|---|
| `FORD_F_150_LIGHTNING_MK1` | 9 | +10.4% ± 3.7% (med +11.0%) | +53.6% ± 1.6% (med +53.9%) |
| `FORD_MUSTANG_MACH_E_MK1` | 9 | +46.5% ± 4.0% (med +46.5%) | +14.0% ± 6.1% (med +12.8%) |

## Per-agent canonical scorecard

| agent | family | status | yaw V0 | yaw final | yaw Δ% | CTE V0 | CTE final | CTE Δ% | n seg ok/total | wall |
|---|---|---|---|---|---|---|---|---|---|---|
| `m1-agent-01` | `module-1` | ok | 0.014563 | 0.009662 | **+33.6%** | 147.44 | 113.09 | **+23.3%** | 130/130 | 1.02s |
| `m1-agent-02` | `module-1` | ok | 0.014563 | 0.009855 | **+32.3%** | 147.44 | 96.40 | **+34.6%** | 130/130 | 1.02s |
| `m1-agent-03` | `module-1` | ok | 0.014563 | 0.010105 | **+30.6%** | 147.44 | 111.86 | **+24.1%** | 130/130 | 1.28s |
| `m1-agent-04` | `module-1` | ok | 0.014563 | 0.010244 | **+29.7%** | 147.44 | 113.11 | **+23.3%** | 130/130 | 1.01s |
| `m1-agent-05` | `module-1` | ok | 0.014563 | 0.010256 | **+29.6%** | 147.44 | 115.28 | **+21.8%** | 130/130 | 1.39s |
| `m1-agent-06` | `module-1` | ok | 0.014563 | 0.010181 | **+30.1%** | 147.44 | 109.33 | **+25.8%** | 130/130 | 1.02s |
| `m1-agent-07` | `module-1` | ok | 0.014563 | 0.009701 | **+33.4%** | 147.44 | 107.88 | **+26.8%** | 130/130 | 1.67s |
| `m1-agent-08` | `module-1` | ok | 0.014563 | 0.011518 | **+20.9%** | 147.44 | 113.56 | **+23.0%** | 130/130 | 1.55s |
| `m1-agent-09` | `module-1` | ❌ **missing_manifest_json** | — | — | — | — | — | — | 0/0 | — |
| `m1-agent-10` | `module-1` | ok | 0.014563 | 0.009936 | **+31.8%** | 147.44 | 123.15 | **+16.5%** | 130/130 | 2.03s |
...
| `has_manifest_json` | 9 | 1 |
| `manifest_parsable` | 9 | 1 |
| `manifest_declares_predict_callable` | 9 | 1 |
| `manifest_declares_platform_support` | 9 | 1 |
| `has_predict_py` | 9 | 1 |
| `has_coeffs_json` | 8 | 2 |
| `has_report` | 0 | 10 |
...
- `missing_manifest_json` — 1 agent(s)
