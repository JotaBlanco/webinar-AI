...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-10/final-model`
...
5. **Write strict JSON to `/Users/javiquix/Desktop/quixdev/webinar-AI/_grade/20260529-021553/canonical/m1-agent-10.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for m1-agent-10: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-10/final-model/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-10/final-model/data/` (these are symlinks to shared, read-only resources).
