"""Fit per-platform model with polynomial steering: yr_ss = v*(g0*d + g2*d*|d| + delta0) / (L + K_us*v^2)."""
import sys
...
def yr_steady_poly(delta, v, g0, g2, delta0, K_us, L):
    """Polynomial steering: g0*d + g2*d*|d|."""
...
def predict_one(t, v, delta, params, L):
    ...
    yr_ss = yr_steady_poly(delta, v, g0, g2, delta0, K_us, L)
...
with open(ROOT / "scratch" / "coeffs_poly.json", "w") as fh:
