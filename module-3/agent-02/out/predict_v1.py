"""V1: KS + understeer + first-order lag + per-segment delta0 (legal cousin).

Recipe from references/anti-patterns.md § "The legal cousin", using the
top-tier m3 cohort coefficients as a starting point.
"""
import numpy as np
import pandas as pd
