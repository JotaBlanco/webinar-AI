...
def split(
    ...
    if stratify_by_platform:
        ...
        for platform in sorted(by_platform.keys()):
            ...
            # randomised by PYTHONHASHSEED and would silently make the split
            # non-deterministic across runs (the bug v2.01 hit on first use).
            pool_seed = seed ^ (zlib.crc32(platform.encode("utf-8")) & 0xFFFFFFFF)
