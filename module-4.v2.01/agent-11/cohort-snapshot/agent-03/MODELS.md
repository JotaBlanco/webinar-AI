...
- vs-parent: n/a
- gate: pass
- next: shipped as final-model
- notes: V1 baseline shipped. Rung-1 (m1) climb attempted but L-BFGS-B converged at init (zero numerical gradient); Nelder-Mead exceeded budget. M4 (orthogonal relaxation-length) net loss vs V1.
