...
- agent_id: **agent-05_final-model**
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-05/final-model`
...
```json
{
  ...
  "computed_at": "2026-05-29T00:39:09",
  "rmse_rad_per_s": 0.0145625552519141,
  "n_samples_after_filter": 318760,
  "truth_channel": "yaw_rate_meas_rads",
  "sample_filter": "v_mps > 2.0"
...
5. **Write strict JSON to `module-1/_grade/canonical/agent-05_final-model.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for agent-05_final-model: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-05/final-model/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-05/final-model/data/` (these are symlinks to shared, read-only resources).
