...
- agent_id: **agent-04_final-model**
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-04/final-model`
...
5. **Write strict JSON to `module-1/_grade/canonical/agent-04_final-model.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for agent-04_final-model: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-04/final-model/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/module-1/agent-04/final-model/data/` (these are symlinks to shared, read-only resources).
