"""Shipped model — thin re-export of models/v1-plus-resid/predict.py.

Adds a per-platform linear residual correction on top of V1.
See `models/v1-plus-resid/notes.md` for the full formulation and rationale.
"""
...
# V1 lives at agent-root/code/v1_baseline.py
