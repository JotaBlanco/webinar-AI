"""Variant B: V1 with refit coefficients."""
import sys, json
...
PARAMS = json.loads((ROOT / "out" / "fitted_coeffs.json").read_text())
...
if __name__ == "__main__":
    ...
    print(f"Variant B  yaw={res['yaw_rate_rmse']:.6f}  cte={res['cte_rmse']:.4f}")
