...
- **reconstructed**: 28 ok / 1 failed (wall 4.63s, concurrency 8)

## Headline

- 🥇 **Best yaw**: `m3-agent-10` (+34.8%)
- 🥇 **Best CTE**: `m3-agent-09` (+51.2%)
- 🎯 **Winning both KPIs ≥ +30%** (2 agents): `m3-agent-10`, `m2-agent-04`
...
|---|---|---|---|---|
| `module-1` | 8/9 | +24.1% ± 9.9% (med +29.6%) | +23.4% ± 1.4% (med +24.1%) | 1 |
| `module-2` | 10/10 | +31.8% ± 4.4% (med +33.3%) | +24.3% ± 4.6% (med +24.7%) | 0 |
| `module-3` | 10/10 | +30.3% ± 6.1% (med +32.8%) | +22.9% ± 14.2% (med +22.4%) | 0 |
...
|---|---|---|---|
| `FORD_F_150_LIGHTNING_MK1` | 28 | +11.2% ± 5.7% (med +13.1%) | +54.0% ± 2.1% (med +54.0%) |
| `FORD_MUSTANG_MACH_E_MK1` | 27 | +44.7% ± 9.8% (med +49.1%) | +11.5% ± 9.2% (med +13.8%) |

## Per-agent canonical scorecard

| agent | family | status | yaw V0 | yaw final | yaw Δ% | CTE V0 | CTE final | CTE Δ% | n seg ok/total | wall |
|---|---|---|---|---|---|---|---|---|---|---|
| `m1-agent-01` | `module-1` | ok | 0.014563 | 0.009667 | **+33.6%** | 147.44 | 113.32 | **+23.1%** | 130/130 | 2.05s |
| `m1-agent-02` | `module-1` | ok | 0.014563 | 0.009811 | **+32.6%** | 147.44 | 111.35 | **+24.5%** | 130/130 | 1.2s |
| `m1-agent-03` | `module-1` | ok | 0.014563 | 0.010352 | **+28.9%** | 147.44 | 118.00 | **+20.0%** | 130/130 | 1.62s |
| `m1-agent-04` | `module-1` | ok | 0.014563 | 0.009751 | **+33.0%** | 147.44 | 111.33 | **+24.5%** | 130/130 | 1.6s |
| `m1-agent-05` | `module-1` | ok | 0.014563 | 0.010163 | **+30.2%** | 147.44 | 113.91 | **+22.7%** | 130/130 | 1.2s |
| `m1-agent-06` | `module-1` | ok | 0.014563 | 0.012969 | **+10.9%** | 147.44 | 111.84 | **+24.1%** | 130/130 | 1.2s |
| `m1-agent-07` | `module-1` | ❌ **import_failed** | — | — | — | — | — | — | 0/0 | — |
| `m1-agent-09` | `module-1` | ok | 0.014563 | 0.012776 | **+12.3%** | 147.44 | 112.11 | **+24.0%** | 130/130 | 1.72s |
| `m1-agent-10` | `module-1` | ok | 0.014563 | 0.012969 | **+10.9%** | 147.44 | 111.84 | **+24.1%** | 130/130 | 0.73s |
| `m2-agent-01` | `module-2` | ok | 0.014563 | 0.011858 | **+18.6%** | 147.44 | 125.24 | **+15.1%** | 130/130 | 0.91s |
| `m2-agent-02` | `module-2` | ok | 0.014563 | 0.009718 | **+33.3%** | 147.44 | 111.64 | **+24.3%** | 130/130 | 0.84s |
| `m2-agent-03` | `module-2` | ok | 0.014563 | 0.009652 | **+33.7%** | 147.44 | 108.15 | **+26.6%** | 130/130 | 0.85s |
| `m2-agent-04` | `module-2` | ok | 0.014563 | 0.009677 | **+33.5%** | 147.44 | 98.56 | **+33.2%** | 130/130 | 0.87s |
| `m2-agent-05` | `module-2` | ok | 0.014563 | 0.009932 | **+31.8%** | 147.44 | 120.37 | **+18.4%** | 130/130 | 0.87s |
| `m2-agent-06` | `module-2` | ok | 0.014563 | 0.009691 | **+33.5%** | 147.44 | 110.41 | **+25.1%** | 130/130 | 0.9s |
| `m2-agent-07` | `module-2` | ok | 0.014563 | 0.009780 | **+32.8%** | 147.44 | 107.90 | **+26.8%** | 130/130 | 0.83s |
| `m2-agent-08` | `module-2` | ok | 0.014563 | 0.009704 | **+33.4%** | 147.44 | 111.30 | **+24.5%** | 130/130 | 0.74s |
| `m2-agent-09` | `module-2` | ok | 0.014563 | 0.009712 | **+33.3%** | 147.44 | 110.87 | **+24.8%** | 130/130 | 1.44s |
| `m2-agent-10` | `module-2` | ok | 0.014563 | 0.009650 | **+33.7%** | 147.44 | 111.87 | **+24.1%** | 130/130 | 0.85s |
| `m3-agent-01` | `module-3` | ok | 0.014563 | 0.009632 | **+33.9%** | 147.44 | 103.49 | **+29.8%** | 130/130 | 1.52s |
| `m3-agent-02` | `module-3` | ok | 0.014563 | 0.010084 | **+30.8%** | 147.44 | 130.30 | **+11.6%** | 130/130 | 0.87s |
| `m3-agent-03` | `module-3` | ok | 0.014563 | 0.009715 | **+33.3%** | 147.44 | 114.96 | **+22.0%** | 130/130 | 0.85s |
| `m3-agent-04` | `module-3` | ok | 0.014563 | 0.009805 | **+32.7%** | 147.44 | 117.47 | **+20.3%** | 130/130 | 0.88s |
| `m3-agent-05` | `module-3` | ok | 0.014563 | 0.009870 | **+32.2%** | 147.44 | 119.09 | **+19.2%** | 130/130 | 0.86s |
| `m3-agent-06` | `module-3` | ok | 0.014563 | 0.010956 | **+24.8%** | 147.44 | 158.42 | **-7.4%** | 130/130 | 0.91s |
| `m3-agent-07` | `module-3` | ok | 0.014563 | 0.009594 | **+34.1%** | 147.44 | 105.76 | **+28.3%** | 130/130 | 0.84s |
| `m3-agent-08` | `module-3` | ok | 0.014563 | 0.009758 | **+33.0%** | 147.44 | 113.80 | **+22.8%** | 130/130 | 0.85s |
| `m3-agent-09` | `module-3` | ok | 0.014563 | 0.012550 | **+13.8%** | 147.44 | 71.94 | **+51.2%** | 55/130 | 0.7s |
| `m3-agent-10` | `module-3` | ok | 0.014563 | 0.009495 | **+34.8%** | 147.44 | 101.13 | **+31.4%** | 130/130 | 0.81s |
...
| `m1-agent-06` | 125 | 0.0020 | 0.0087 | 0.0156 | 0.6886 | 0.0608 |
...
| `m3-agent-02` | 125 | 0.0025 | 0.0061 | 0.0119 | 0.6646 | 0.0587 |
...
## ⚠️ Operating-contract audit — agents whose predict() referenced truth columns
...
| agent | family | columns referenced inside predict() | canonical yaw Δ% | canonical CTE Δ% |
|---|---|---|---|---|
| `m1-agent-06` | `module-1` | `yaw_rate_meas_rads` | +10.9% | +24.1% |
| `m3-agent-02` | `module-3` | `a_lat_meas_mps2` | +30.8% | +11.6% |
| `m3-agent-06` | `module-3` | `a_lat_meas_mps2` | +24.8% | -7.4% |
| `m3-agent-09` | `module-3` | `a_lat_meas_mps2` | +13.8% | +51.2% |
