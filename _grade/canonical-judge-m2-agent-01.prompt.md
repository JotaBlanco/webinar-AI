...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-01/final-model`
- report: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-01/final-model/methodology.txt`
...
```json
{
  ...
  "computed_at": "2026-05-29T01:28:09",
  "rmse_rad_per_s": 0.0145625552519141,
  "n_samples_after_filter": 318760,
  "truth_channel": "yaw_rate_meas_rads",
  "sample_filter": "v_mps > 2.0"
...
5. **Write strict JSON to `_grade/canonical/m2-agent-01.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for m2-agent-01: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-01/final-model/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-01/final-model/data/` (these are symlinks to shared, read-only resources).
