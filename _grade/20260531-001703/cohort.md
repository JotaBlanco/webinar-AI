...
- **reconstructed**: 28 ok / 1 failed (wall 4.0s, concurrency 8)
...
|---|---|---|---|---|---|---|---|---|---|---|
| `m1-agent-01` | `module-1` | ok | 0.014563 | 0.009667 | **+33.6%** | 147.44 | 113.32 | **+23.1%** | 130/130 | 1.85s |
| `m1-agent-02` | `module-1` | ok | 0.014563 | 0.009811 | **+32.6%** | 147.44 | 111.35 | **+24.5%** | 130/130 | 0.94s |
| `m1-agent-03` | `module-1` | ok | 0.014563 | 0.010352 | **+28.9%** | 147.44 | 118.00 | **+20.0%** | 130/130 | 1.42s |
| `m1-agent-04` | `module-1` | ok | 0.014563 | 0.009751 | **+33.0%** | 147.44 | 111.33 | **+24.5%** | 130/130 | 1.42s |
| `m1-agent-05` | `module-1` | ok | 0.014563 | 0.010163 | **+30.2%** | 147.44 | 113.91 | **+22.7%** | 130/130 | 0.94s |
| `m1-agent-06` | `module-1` | ok | 0.014563 | 0.011662 | **+19.9%** | 147.44 | 31.25 | **+78.8%** | 130/130 | 0.94s |
| `m1-agent-07` | `module-1` | ❌ **import_failed** | — | — | — | — | — | — | 0/0 | — |
| `m1-agent-09` | `module-1` | ok | 0.014563 | 0.012776 | **+12.3%** | 147.44 | 112.11 | **+24.0%** | 130/130 | 1.52s |
| `m1-agent-10` | `module-1` | ok | 0.014563 | 0.012969 | **+10.9%** | 147.44 | 111.84 | **+24.1%** | 130/130 | 0.57s |
| `m2-agent-01` | `module-2` | ok | 0.014563 | 0.011858 | **+18.6%** | 147.44 | 125.24 | **+15.1%** | 130/130 | 0.75s |
| `m2-agent-02` | `module-2` | ok | 0.014563 | 0.009718 | **+33.3%** | 147.44 | 111.64 | **+24.3%** | 130/130 | 0.68s |
| `m2-agent-03` | `module-2` | ok | 0.014563 | 0.009652 | **+33.7%** | 147.44 | 108.15 | **+26.6%** | 130/130 | 0.69s |
| `m2-agent-04` | `module-2` | ok | 0.014563 | 0.009677 | **+33.5%** | 147.44 | 98.56 | **+33.2%** | 130/130 | 0.72s |
| `m2-agent-05` | `module-2` | ok | 0.014563 | 0.009932 | **+31.8%** | 147.44 | 120.37 | **+18.4%** | 130/130 | 0.74s |
| `m2-agent-06` | `module-2` | ok | 0.014563 | 0.009691 | **+33.5%** | 147.44 | 110.41 | **+25.1%** | 130/130 | 0.77s |
...
| `m2-agent-09` | `module-2` | ok | 0.014563 | 0.009712 | **+33.3%** | 147.44 | 110.87 | **+24.8%** | 130/130 | 1.75s |
| `m2-agent-10` | `module-2` | ok | 0.014563 | 0.009650 | **+33.7%** | 147.44 | 111.87 | **+24.1%** | 130/130 | 0.71s |
| `m3-agent-01` | `module-3` | ok | 0.014563 | 0.009632 | **+33.9%** | 147.44 | 103.49 | **+29.8%** | 130/130 | 1.35s |
| `m3-agent-02` | `module-3` | ok | 0.014563 | 0.009145 | **+37.2%** | 147.44 | 73.44 | **+50.2%** | 130/130 | 0.73s |
| `m3-agent-03` | `module-3` | ok | 0.014563 | 0.009715 | **+33.3%** | 147.44 | 114.96 | **+22.0%** | 130/130 | 0.69s |
| `m3-agent-04` | `module-3` | ok | 0.014563 | 0.009805 | **+32.7%** | 147.44 | 117.47 | **+20.3%** | 130/130 | 0.72s |
| `m3-agent-05` | `module-3` | ok | 0.014563 | 0.009870 | **+32.2%** | 147.44 | 119.09 | **+19.2%** | 130/130 | 0.7s |
| `m3-agent-06` | `module-3` | ok | 0.014563 | 0.008982 | **+38.3%** | 147.44 | 70.86 | **+51.9%** | 130/130 | 0.75s |
| `m3-agent-07` | `module-3` | ok | 0.014563 | 0.009594 | **+34.1%** | 147.44 | 105.76 | **+28.3%** | 130/130 | 0.68s |
| `m3-agent-08` | `module-3` | ok | 0.014563 | 0.009758 | **+33.0%** | 147.44 | 113.80 | **+22.8%** | 130/130 | 0.71s |
| `m3-agent-09` | `module-3` | ok | 0.014563 | 0.008946 | **+38.6%** | 147.44 | 71.12 | **+51.8%** | 130/130 | 0.71s |
| `m3-agent-10` | `module-3` | ok | 0.014563 | 0.009495 | **+34.8%** | 147.44 | 101.13 | **+31.4%** | 130/130 | 0.7s |
