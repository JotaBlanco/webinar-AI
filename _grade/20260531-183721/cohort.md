...
- **reconstructed**: 28 ok / 1 failed (wall 4.16s, concurrency 8)
...
|---|---|---|---|---|---|---|---|---|---|---|
| `m1-agent-01` | `module-1` | ok | **+33.6%** | **+23.1%** | +33.7% | +60.0% | +0.1% | +36.9% | 130/130 | 1.93s |
| `m1-agent-02` | `module-1` | ok | **+32.6%** | **+24.5%** | +55.0% | +52.0% | +22.4% | +27.5% | 130/130 | 1.01s |
| `m1-agent-03` | `module-1` | ok | **+28.9%** | **+20.0%** | — | — | — | — | 130/130 | 1.5s |
| `m1-agent-04` | `module-1` | ok | **+33.0%** | **+24.5%** | +64.8% | +70.7% | +31.8% | +46.2% | 130/130 | 1.47s |
| `m1-agent-05` | `module-1` | ok | **+30.2%** | **+22.7%** | +27.3% | +19.9% | -2.9% | -2.8% | 130/130 | 1.01s |
| `m1-agent-06` | `module-1` | ok | **+10.9%** | **+24.1%** | — | — | — | — | 130/130 | 1.01s |
| `m1-agent-07` | `module-1` | ❌ **import_failed** | — | — | — | — | — | — | 0/0 | — |
| `m1-agent-09` | `module-1` | ok | **+12.3%** | **+24.0%** | — | — | — | — | 130/130 | 1.59s |
| `m1-agent-10` | `module-1` | ok | **+10.9%** | **+24.1%** | — | — | — | — | 130/130 | 0.63s |
| `m2-agent-01` | `module-2` | ok | **+18.6%** | **+15.1%** | +24.8% | +29.6% | +6.2% | +14.5% | 130/130 | 0.8s |
| `m2-agent-02` | `module-2` | ok | **+33.3%** | **+24.3%** | +47.5% | +33.0% | +14.2% | +8.7% | 130/130 | 0.73s |
| `m2-agent-03` | `module-2` | ok | **+33.7%** | **+26.6%** | +47.0% | +33.0% | +13.3% | +6.4% | 130/130 | 0.75s |
| `m2-agent-04` | `module-2` | ok | **+33.5%** | **+33.2%** | +50.0% | +36.0% | +16.5% | +2.8% | 130/130 | 0.73s |
| `m2-agent-05` | `module-2` | ok | **+31.8%** | **+18.4%** | +34.9% | +28.5% | +3.1% | +10.1% | 130/130 | 0.74s |
| `m2-agent-06` | `module-2` | ok | **+33.5%** | **+25.1%** | +51.0% | +33.0% | +17.5% | +7.9% | 130/130 | 0.79s |
| `m2-agent-07` | `module-2` | ok | **+32.8%** | **+26.8%** | +44.2% | +22.7% | +11.4% | -4.1% | 130/130 | 0.7s |
| `m2-agent-08` | `module-2` | ok | **+33.4%** | **+24.5%** | +44.5% | +22.6% | +11.1% | -1.9% | 130/130 | 0.63s |
| `m2-agent-09` | `module-2` | ok | **+33.3%** | **+24.8%** | +47.7% | +32.8% | +14.4% | +8.0% | 130/130 | 1.33s |
| `m2-agent-10` | `module-2` | ok | **+33.7%** | **+24.1%** | +48.0% | +33.0% | +14.3% | +8.9% | 130/130 | 0.72s |
| `m3-agent-01` | `module-3` | ok | **+33.9%** | **+29.8%** | +45.8% | +30.6% | +11.9% | +0.8% | 130/130 | 1.38s |
| `m3-agent-02` | `module-3` | ok | **+30.8%** | **+11.6%** | +46.1% | +28.1% | +15.3% | +16.5% | 130/130 | 0.74s |
| `m3-agent-03` | `module-3` | ok | **+33.3%** | **+22.0%** | +51.0% | +33.0% | +17.7% | +11.0% | 130/130 | 0.72s |
| `m3-agent-04` | `module-3` | ok | **+32.7%** | **+20.3%** | +51.0% | +33.0% | +18.3% | +12.7% | 130/130 | 0.75s |
| `m3-agent-05` | `module-3` | ok | **+32.2%** | **+19.2%** | +47.0% | +33.0% | +14.8% | +13.8% | 130/130 | 0.73s |
| `m3-agent-06` | `module-3` | ok | **+24.8%** | **-7.4%** | +49.8% | +41.4% | +25.0% | +48.8% | 130/130 | 0.77s |
| `m3-agent-07` | `module-3` | ok | **+34.1%** | **+28.3%** | +47.0% | +32.0% | +12.9% | +3.7% | 130/130 | 0.71s |
| `m3-agent-08` | `module-3` | ok | **+33.0%** | **+22.8%** | +51.0% | +33.0% | +18.0% | +10.2% | 130/130 | 0.73s |
| `m3-agent-09` | `module-3` | ok | **+13.8%** | **+51.2%** | +45.0% | +47.0% | +31.2% | -4.2% | 55/130 | 0.59s |
| `m3-agent-10` | `module-3` | ok | **+34.8%** | **+31.4%** | +55.0% | +28.0% | +20.2% | -3.4% | 130/130 | 0.71s |
...
| `m1-agent-06` | `module-1` | — | +10.9% | — | — | +24.1% | — | no quantitative claim |
...
| `m3-agent-02` | `module-3` | +46.1% | +30.8% | +15.3% | +28.1% | +11.6% | +16.5% |  |
