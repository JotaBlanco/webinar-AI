...
5. **Write strict JSON to `/Users/javiquix/Desktop/quixdev/webinar-AI/_grade/20260529-021553/canonical/m1-agent-05.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for m1-agent-05: status=<ok|failed>`. Nothing else.
