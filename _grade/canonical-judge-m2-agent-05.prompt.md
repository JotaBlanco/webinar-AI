...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-05/final-model`
- report: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-05/final-model/methodology.md`
...
5. **Write strict JSON to `_grade/canonical/m2-agent-05.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for m2-agent-05: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-05/final-model/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-05/final-model/data/` (these are symlinks to shared, read-only resources).
