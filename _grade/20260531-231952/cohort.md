...
- **reconstructed**: 20 ok / 0 failed (wall 3.58s, concurrency 8)

## Headline

- 🥇 **Best yaw**: `m1-agent-01` (+40.6%)
- 🥇 **Best CTE**: `m1-agent-02` (+62.1%)
- 🎯 **Winning both KPIs ≥ +30%** (18 agents): `m1-agent-01`, `m1-agent-07`, `m2-agent-05`, `m1-agent-09`, `m2-agent-08`, `m1-agent-02`, `m2-agent-07`, `m1-agent-10`, `m2-agent-02`, `m2-agent-10`, `m2-agent-01`, `m2-agent-09`, `m2-agent-03`, `m1-agent-03`, `m1-agent-06`, `m2-agent-06`, `m1-agent-04`, `m1-agent-05`
...
|---|---|---|---|
| `FORD_F_150_LIGHTNING_MK1` | 20 | +20.4% ± 2.5% (med +20.5%) | +73.1% ± 1.0% (med +73.3%) |
| `FORD_MUSTANG_MACH_E_MK1` | 20 | +51.9% ± 4.2% (med +52.4%) | +49.4% ± 4.6% (med +50.1%) |

## Per-agent canonical scorecard

| agent | family | status | yaw V0 | yaw final | yaw Δ% | CTE V0 | CTE final | CTE Δ% | n seg ok/total | wall |
|---|---|---|---|---|---|---|---|---|---|---|
| `m1-agent-01` | `module-1` | ok | 0.016274 | 0.009662 | **+40.6%** | 254.26 | 113.09 | **+55.5%** | 130/534 | 1.16s |
| `m1-agent-02` | `module-1` | ok | 0.016274 | 0.009855 | **+39.4%** | 254.26 | 96.40 | **+62.1%** | 130/534 | 1.16s |
| `m1-agent-03` | `module-1` | ok | 0.016274 | 0.010105 | **+37.9%** | 254.26 | 111.86 | **+56.0%** | 130/534 | 1.53s |
| `m1-agent-04` | `module-1` | ok | 0.016274 | 0.010244 | **+37.0%** | 254.26 | 113.11 | **+55.5%** | 130/534 | 1.16s |
| `m1-agent-05` | `module-1` | ok | 0.016274 | 0.010256 | **+37.0%** | 254.26 | 115.28 | **+54.7%** | 130/534 | 1.64s |
| `m1-agent-06` | `module-1` | ok | 0.016274 | 0.010181 | **+37.4%** | 254.26 | 109.33 | **+57.0%** | 130/534 | 1.16s |
| `m1-agent-07` | `module-1` | ok | 0.016274 | 0.009701 | **+40.4%** | 254.26 | 107.88 | **+57.6%** | 130/534 | 1.92s |
| `m1-agent-08` | `module-1` | ok | 0.016274 | 0.011518 | **+29.2%** | 254.26 | 113.56 | **+55.3%** | 130/534 | 1.83s |
| `m1-agent-09` | `module-1` | ok | 0.016274 | 0.009753 | **+40.1%** | 254.26 | 103.36 | **+59.3%** | 130/534 | 0.84s |
| `m1-agent-10` | `module-1` | ok | 0.016274 | 0.009936 | **+38.9%** | 254.26 | 123.15 | **+51.6%** | 130/534 | 2.17s |
| `m2-agent-01` | `module-2` | ok | 0.016274 | 0.010049 | **+38.3%** | 254.26 | 108.77 | **+57.2%** | 130/534 | 0.75s |
| `m2-agent-02` | `module-2` | ok | 0.016274 | 0.010010 | **+38.5%** | 254.26 | 106.11 | **+58.3%** | 130/534 | 0.75s |
| `m2-agent-03` | `module-2` | ok | 0.016274 | 0.010104 | **+37.9%** | 254.26 | 111.85 | **+56.0%** | 130/534 | 0.76s |
| `m2-agent-04` | `module-2` | ok | 0.016274 | 0.011514 | **+29.2%** | 254.26 | 141.71 | **+44.3%** | 130/534 | 1.26s |
| `m2-agent-05` | `module-2` | ok | 0.016274 | 0.009714 | **+40.3%** | 254.26 | 113.68 | **+55.3%** | 130/534 | 0.79s |
| `m2-agent-06` | `module-2` | ok | 0.016274 | 0.010189 | **+37.4%** | 254.26 | 116.48 | **+54.2%** | 130/534 | 0.8s |
| `m2-agent-07` | `module-2` | ok | 0.016274 | 0.009925 | **+39.0%** | 254.26 | 123.02 | **+51.6%** | 130/534 | 0.91s |
| `m2-agent-08` | `module-2` | ok | 0.016274 | 0.009788 | **+39.9%** | 254.26 | 111.80 | **+56.0%** | 130/534 | 0.89s |
| `m2-agent-09` | `module-2` | ok | 0.016274 | 0.010082 | **+38.0%** | 254.26 | 111.16 | **+56.3%** | 130/534 | 0.78s |
| `m2-agent-10` | `module-2` | ok | 0.016274 | 0.010041 | **+38.3%** | 254.26 | 108.70 | **+57.2%** | 130/534 | 0.77s |
