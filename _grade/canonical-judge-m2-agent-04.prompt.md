...
- agent folder: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-04/final-model`
- report: `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-04/final-model/REPORT.txt`
...
5. **Write strict JSON to `_grade/canonical/m2-agent-04.json`.** No prose around it, no markdown fence.
...
After writing, return one short sentence: `Canonical eval for m2-agent-04: status=<ok|failed>`. Nothing else.
...
- Modify files under `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-04/final-model/code/` or `/Users/javiquix/Desktop/quixdev/webinar-AI/module-2/agent-04/final-model/data/` (these are symlinks to shared, read-only resources).
